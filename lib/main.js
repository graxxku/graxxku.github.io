...
async function recordData() {
    ...
    for (let i = 0; i < 5; i++) { // Loop 5 times for 5 samples
        ...
        let imu = await ble.readValue().then(dataview => {
            ...
            return { id: timestamp, content: { accelerometer: accData, gyroscope: gyroData } };
        });
...
function toSigned16Bit(highByte, lowByte) {
