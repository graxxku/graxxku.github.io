...
async function recordData() {
    ...
    //             const acc_x = toSigned16Bit(buf[1], buf[0]);
    //             const acc_y = toSigned16Bit(buf[3], buf[2]);
    //             const acc_z = toSigned16Bit(buf[5], buf[4]);
            
    //             const gyro_x = toSigned16Bit(buf[7], buf[6]);
    //             const gyro_y = toSigned16Bit(buf[9], buf[8]);
    //             const gyro_z = toSigned16Bit(buf[11], buf[10]);
